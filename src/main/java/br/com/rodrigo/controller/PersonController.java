...
public class PersonController {
	...
	@Operation(summary = "Finds person by name", description = "Finds person",
		tags = {"Person"},
		responses = {
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonByName(
		...
		return ResponseEntity.ok(service.findPersonByName(firstName,pegeable));
	}
	...
	@PatchMapping(value = "/{id}",
		produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML  })
	@Operation(summary = "Disabled a Person", description = "Disabled a Person",
		tags = {"People"},
		responses = {
			@ApiResponse(description = "Success", responseCode = "200",
				content = @Content(schema = @Schema(implementation = PersonVO.class))
