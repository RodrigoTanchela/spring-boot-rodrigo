package br.com.rodrigo.integrationtests.controller.cors.withYaml;
...
import br.com.rodrigo.unittests.mapper.YamlMapper;
				...
				.config(
						RestAssuredConfig
							...
							.encoderConfig(EncoderConfig.encoderConfig()
								.encodeContentTypeAs(
									TestConfigs.CONTENTE_TYPE_YML,
									ContentType.TEXT)))
				.basePath("/auth/signin")
					.port(TestConfigs.SERVER_PORT)
					.contentType(TestConfigs.CONTENTE_TYPE_YML)
					.accept(TestConfigs.CONTENTE_TYPE_YML)
